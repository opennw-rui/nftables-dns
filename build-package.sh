...
package ($new) beta; urgency=medium
Please check the source repo for the full changelog
You can found the link at https://github.com/opennw-rui/nftables-dns
-- opennw-rui <github@opennw-rui> $(date -R)
EOL
